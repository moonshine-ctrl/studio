...
export const users: User[] = [
  ...
  { id: '3', name: 'Doni Firmansyah', nip: '199811102022021003', avatar: 'https://picsum.photos/seed/3/100/100', departmentId: 'finance', role: 'Employee', annualLeaveBalance: 5, phone: '6281234567892', golongan: 'II/c', joinDate: new Date('2022-02-01'), qrCodeSignature: 'https://placehold.co/100x100.png' },
  ...
  { id: '5', name: 'Fitriani', nip: '199003252017062002', avatar: 'https://picsum.photos/seed/5/100/100', departmentId: 'hr', role: 'Employee', annualLeaveBalance: 8, phone: '6281234567894', golongan: 'IV/a', joinDate: new Date('2017-06-15'), qrCodeSignature: 'https://placehold.co/100x100.png' },
  ...
  { id: '7', name: 'Hana Yulita', nip: '199107212018112003', avatar: 'https://picsum.photos/seed/7/100/100', departmentId: 'finance', role: 'Employee', annualLeaveBalance: 9, phone: '6281234567896', golongan: 'IV/b', joinDate: new Date('2018-11-01'), qrCodeSignature: 'https://placehold.co/100x100.png' },
  ...
  { id: 'admin', name: 'Admin User', nip: '199001012020121001', avatar: 'https://picsum.photos/seed/admin/100/100', departmentId: 'hr', role: 'Admin', annualLeaveBalance: 0, phone: '6281200000000', golongan: 'IV/c', joinDate: new Date('2020-12-01'), qrCodeSignature: 'https://placehold.co/100x100.png'},
];
